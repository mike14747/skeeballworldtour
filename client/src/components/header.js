    ...
    return (
        <div className="row mb-3" style={{ backgroundImage: 'url("/images/head_bg_new.jpg")', backgroundSize: 'cover' }}>
            ...
            <div className="col-4 p-2 my-auto text-center">
                ...
                <img className="mx-2 img-fluid" src="/images/winking_lizard_logo.png" alt="Winking Lizard" width="70" height="60" />
                <img className="mx-2 img-fluid" src="/images/bell_music_logo.png" alt="Bell Music" width="150" height="56" />
            </div>
