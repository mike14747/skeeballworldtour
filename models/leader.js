...
const Leader = {
    getIndividualAverageBySeasonId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT COUNT(*)*10 AS player_played, ROUND(AVG(r.g1+r.g2+r.g3+r.g4+r.g5+r.g6+r.g7+r.g8+r.g9+r.g10)/10,5) AS data, tp.team_played FROM results AS r JOIN (SELECT (wins+losses+ties) AS team_played, season_id, store_id, division_id, team_id FROM standings ORDER BY season_id DESC, store_id ASC, division_id ASC, team_played DESC) AS tp ON (r.season_id=tp.season_id && r.store_id=tp.store_id && r.division_id=tp.division_id && r.team_id=tp.team_id) WHERE r.season_id=@season_id && r.player_id!=100 GROUP BY r.season_id, r.player_id HAVING player_played>=team_played/2 ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT COUNT(*)*10 AS player_played, ROUND(AVG(r.g1+r.g2+r.g3+r.g4+r.g5+r.g6+r.g7+r.g8+r.g9+r.g10)/10,5) AS data, tp.team_played FROM results AS r JOIN (SELECT (wins+losses+ties) AS team_played, season_id, store_id, division_id, team_id FROM standings ORDER BY season_id DESC, store_id ASC, division_id ASC, team_played DESC) AS tp ON (r.season_id=tp.season_id && r.store_id=tp.store_id && r.division_id=tp.division_id && r.team_id=tp.team_id) WHERE r.season_id=@season_id && r.player_id!=100 GROUP BY r.season_id, r.player_id HAVING player_played>=team_played/2 ORDER BY data DESC LIMIT ?, 1) AS r2;';
            const tiesInfo = 'SELECT (CASE WHEN @tie_value_num_leaders=@tie_value_num_leaders_plus_one THEN (SELECT COUNT(*) FROM (SELECT COUNT(*)*10 AS player_played, ROUND(AVG(r.g1+r.g2+r.g3+r.g4+r.g5+r.g6+r.g7+r.g8+r.g9+r.g10)/10,5) AS data, tp.team_played FROM results AS r JOIN (SELECT (wins+losses+ties) AS team_played, season_id, store_id, division_id, team_id FROM standings ORDER BY season_id DESC, store_id ASC, division_id ASC, team_played DESC) AS tp ON (r.season_id=tp.season_id && r.store_id=tp.store_id && r.division_id=tp.division_id && r.team_id=tp.team_id) WHERE r.season_id=@season_id && r.player_id!=100 GROUP BY r.season_id, r.player_id HAVING player_played>=team_played/2 && data=@tie_value_num_leaders_plus_one) AS nt) ELSE 0 END) AS num_at_tie_value, @tie_value_num_leaders AS tie_value;';
    ...
    getIndividualOneGameBySeasonId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT tv1.data FROM (SELECT g1 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g2 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g3 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g4 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g5 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g6 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g7 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g8 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g9 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g10 AS data FROM results WHERE season_id=@season_id && player_id!=100) AS tv1 ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT tv1.data FROM (SELECT g1 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g2 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g3 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g4 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g5 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g6 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g7 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g8 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g9 AS data FROM results WHERE season_id=@season_id && player_id!=100 UNION ALL SELECT g10 AS data FROM results WHERE season_id=@season_id && player_id!=100) AS tv1 ORDER BY data DESC LIMIT ?, 1) AS r2;';
    ...
    getTeamAverageBySeasonId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT ROUND(10*total_points/(st.wins+st.losses+st.ties),5) AS data FROM standings AS st WHERE st.season_id=@season_id GROUP BY st.team_id ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT ROUND(10*total_points/(st.wins+st.losses+st.ties),5) AS data FROM standings AS st WHERE st.season_id=@season_id GROUP BY st.team_id ORDER BY data DESC LIMIT ?, 1) AS r2;';
            const tiesInfo = 'SELECT (CASE WHEN @tie_value_num_leaders=@tie_value_num_leaders_plus_one THEN (SELECT COUNT(*) FROM (SELECT ROUND(10*total_points/(st.wins+st.losses+st.ties),5) AS data FROM standings AS st WHERE st.season_id=@season_id GROUP BY st.team_id HAVING data=@tie_value_num_leaders_plus_one) AS nt) ELSE 0 END) AS num_at_tie_value, @tie_value_num_leaders AS tie_value;';
    ...
    getTeamTenGameBySeasonId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT (SUM(g1)+SUM(g2)+SUM(g3)+SUM(g4)+SUM(g5)+SUM(g6)+SUM(g7)+SUM(g8)+SUM(g9)+SUM(g10)) as data FROM results WHERE season_id=@season_id GROUP BY team_id, week_id ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT (SUM(g1)+SUM(g2)+SUM(g3)+SUM(g4)+SUM(g5)+SUM(g6)+SUM(g7)+SUM(g8)+SUM(g9)+SUM(g10)) as data FROM results WHERE season_id=@season_id GROUP BY team_id, week_id ORDER BY data DESC LIMIT ?, 1) AS r2;';
            const tiesInfo = 'SELECT (CASE WHEN @tie_value_num_leaders=@tie_value_num_leaders_plus_one THEN (SELECT COUNT(*) FROM (SELECT (SUM(g1)+SUM(g2)+SUM(g3)+SUM(g4)+SUM(g5)+SUM(g6)+SUM(g7)+SUM(g8)+SUM(g9)+SUM(g10)) as data FROM results WHERE season_id=@season_id GROUP BY team_id, week_id HAVING data=@tie_value_num_leaders_plus_one ORDER BY data DESC) AS nt) ELSE 0 END) AS num_at_tie_value, @tie_value_num_leaders AS tie_value;';
    ...
    getIndividualOneGameBySeasonStoreDivisionId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT tv1.data FROM (SELECT g1 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g2 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g3 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g4 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g5 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g6 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g7 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g8 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g9 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g10 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id) AS tv1 ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT tv1.data FROM (SELECT g1 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g2 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g3 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g4 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g5 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g6 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g7 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g8 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g9 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id UNION ALL SELECT g10 AS data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id) AS tv1 ORDER BY data DESC LIMIT ?, 1) AS r2;';
    ...
    getIndividualTenGameBySeasonStoreDivisionId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT (g1+g2+g3+g4+g5+g6+g7+g8+g9+g10) as data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id GROUP BY player_id, week_id, team_id, player_num ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT (g1+g2+g3+g4+g5+g6+g7+g8+g9+g10) as data FROM results WHERE season_id=@season_id && player_id!=100 && store_id=@store_id && division_id=@division_id GROUP BY player_id, week_id, team_id, player_num ORDER BY data DESC LIMIT ?, 1) AS r2;';
    ...
    getTeamAverageBySeasonStoreDivisionId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT ROUND(10*total_points/(st.wins+st.losses+st.ties),5) AS data FROM standings AS st WHERE st.season_id=@season_id && st.store_id=@store_id && st.division_id=@division_id GROUP BY st.team_id ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT ROUND(10*total_points/(st.wins+st.losses+st.ties),5) AS data FROM standings AS st WHERE st.season_id=@season_id && st.store_id=@store_id && st.division_id=@division_id GROUP BY st.team_id ORDER BY data DESC LIMIT ?, 1) AS r2;';
    ...
    getTeamTenGameBySeasonStoreDivisionId: async (paramsObj) => {
        try {
            const setTieValueVariables = 'SELECT r1.data, r2.data INTO @tie_value_num_leaders, @tie_value_num_leaders_plus_one FROM (SELECT (SUM(g1)+SUM(g2)+SUM(g3)+SUM(g4)+SUM(g5)+SUM(g6)+SUM(g7)+SUM(g8)+SUM(g9)+SUM(g10)) as data FROM results WHERE season_id=@season_id && store_id=@store_id && division_id=@division_id GROUP BY team_id, week_id ORDER BY data DESC LIMIT ?, 1) AS r1, (SELECT (SUM(g1)+SUM(g2)+SUM(g3)+SUM(g4)+SUM(g5)+SUM(g6)+SUM(g7)+SUM(g8)+SUM(g9)+SUM(g10)) as data FROM results WHERE season_id=@season_id && store_id=@store_id && division_id=@division_id GROUP BY team_id, week_id ORDER BY data DESC LIMIT ?, 1) AS r2;';
